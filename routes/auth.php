...
Route::middleware('guest')->group(function () {
    ...
    Route::get('verify-otp', [PasswordResetOtpController::class, 'showVerifyOtpForm'])
        ->name('password.otp.verify.form');

    Route::post('verify-otp', [PasswordResetOtpController::class, 'verifyOtp'])
        ->name('password.otp.verify');

    Route::post('resend-otp', [PasswordResetOtpController::class, 'resendOtp'])
