<nav class="bg-primary h-screen text-white fixed top-0 left-0 hidden xl:flex xl:flex-col overflow-y-auto w-[335px]">
    ...
    <div
        ...
        <ul class="m-4 text-lg p-0 bg-primary">
            <li>
                <a href="{{ url('/erb-reviewer/dashboard') }}"
                    class="w-full flex items-center px-2 py-3 border-none no-underline gap-x-3 hover:text-secondary transition-all duration-300 {{ Request::is('erb-reviewer/dashboard') ? 'text-secondary' : '' }}">
            ...
            <li>
                <a href="{{ url('/erb-reviewer/protocol-assign') }}"
                    class="w-full flex items-center px-2 py-3 border-none no-underline gap-x-3 hover:text-secondary transition-all duration-300 {{ Request::is('erb-reviewer/protocol-assign') || Request::is('erb-reviewer/submit-documents/*') || Request::is('erb-reviewer/submitted-documents*') ? 'text-secondary' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li>
                <a href="{{ url('/erb-reviewer/monitoring-process') }}"
                    class="w-full flex items-center px-2 py-3 border-none no-underline gap-x-3 hover:text-secondary transition-all duration-300 {{ Request::is('erb-reviewer/monitoring-process') ? 'text-secondary' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
    ...
    <nav
        ...
        <div class="overflow-auto overscroll-contain flex-1">
            <ul class="m-2 p-0 bg-primary">
                <li>
                    <a href="{{ url('/erb-reviewer/dashboard') }}" class="flex items-center max-sm:text-[15px] px-2 py-3 max-sm:py-2.5 border-0 no-underline gap-x-2 cursor-pointer transition-all duration-300 hover:text-secondary 
                ...
                <li>
                    <a href="{{ url('/erb-reviewer/protocol-assign') }}"
                        ...
                        {{ Request::is('erb-reviewer/protocol-assign') || Request::is('erb-reviewer/submit-documents/*') || Request::is('erb-reviewer/submitted-documents*') ? 'text-secondary' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-file-user-icon lucide-file-user">
                            <path
                ...
                <li>
                    <a href="{{ url('/erb-reviewer/monitoring-process') }}" class="flex items-center max-sm:text-[15px] px-2 py-3 max-sm:py-2.5 border-0 no-underline gap-x-2 cursor-pointer transition-all duration-300 hover:text-secondary 
                        {{ Request::is('erb-reviewer/monitoring-process') ? 'text-secondary' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-monitor-cloud-icon lucide-monitor-cloud">
                            <path d="M11 13a3 3 0 1 1 2.83-4H14a2 2 0 0 1 0 4z" />
