    ...
    <nav
        ...
        <div class="overflow-auto overscroll-contain flex-1">
            <ul class="m-2 p-0 bg-primary">
                <li>
                    <a href="{{ url('/superadmin/dashboard') }}"
                        class="flex items-center max-sm:text-[15px] px-2 py-3 max-sm:py-2.5 border-0 no-underline gap-x-3 cursor-pointer transition-all duration-300 hover:text-secondary {{ Request::is('superadmin/dashboard') ? 'text-secondary' : '' }}">
                ...
                <li>
                    <a href="{{ url('/superadmin/accounts-classifications') }}"
                        class="flex items-center max-sm:text-[15px] px-2 py-3 max-sm:py-2.5 border-0 no-underline gap-x-3 cursor-pointer transition-all duration-300 hover:text-secondary {{ Request::is('superadmin/accounts-classifications') ? 'text-secondary' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-user-round-cog-icon lucide-user-round-cog">
                            <path d="m14.305 19.53.923-.382" />
                ...
                <li>
                    <a href="{{ url('/superadmin/research-records') }}"
                        class="flex items-center max-sm:text-[15px] px-2 py-3 max-sm:py-2.5 border-0 no-underline gap-x-3 cursor-pointer transition-all duration-300 hover:text-secondary {{ Request::is('superadmin/research-records') ? 'text-secondary' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-database-icon lucide-database">
                            <ellipse cx="12" cy="5" rx="9" ry="3" />
                ...
                <li>
                    <a href="{{ url('/superadmin/protocol-decision') }}"
                        class="flex items-center max-sm:text-[15px] px-2 py-3 max-sm:py-2.5 border-0 no-underline gap-x-3 cursor-pointer transition-all duration-300 hover:text-secondary {{ Request::is('superadmin/protocol-decision') ? 'text-secondary' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-file-user-icon lucide-file-user">
                            <path
                ...
                <li>
                    <a href="{{ url('/superadmin/permission-control') }}"
                        class="flex items-center max-sm:text-[15px] px-2 py-3 max-sm:py-2.5 border-0 no-underline gap-x-3 cursor-pointer transition-all duration-300 hover:text-secondary {{ Request::is('superadmin/permission-control') ? 'text-secondary' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-user-key-icon lucide-user-key">
                            <path d="M20 11v6" />
                ...
                <li>
                    <a href="{{ url('/superadmin/monitoring-process') }}"
                        class="flex items-center max-sm:text-[15px] px-2 py-3 max-sm:py-2.5 border-0 no-underline gap-x-3 cursor-pointer transition-all duration-300 hover:text-secondary {{ Request::is('superadmin/monitoring-process') ? 'text-secondary' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-monitor-cloud-icon lucide-monitor-cloud">
                            <path d="M11 13a3 3 0 1 1 2.83-4H14a2 2 0 0 1 0 4z" />
